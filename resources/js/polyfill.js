...
(function (self, undefined) {
    ...
    function TrimString(e, u) {
        ...
        else p = "end" === u ? String.prototype.replace.call(t, new RegExp(n + "$", "g"), "") : String.prototype.replace.call(t, new RegExp("^" + n + "|" + n + "$", "g"), "");
        return p
    }
                ...
                value: function (t, e) {
                    ...
                    if ("object" == typeof arguments[0] && arguments[0].constructor === this.constructor) {
                        ...
                        if (y = this.byteOffset + o * this.BYTES_PER_ELEMENT, s = r.length * this.BYTES_PER_ELEMENT, r.buffer === this.buffer) {
                            ...
                            for (u = 0, a = r.byteOffset, h = y; u < s; u += 1, a += 1, h += 1) this.buffer._bytes[h] = r.buffer._bytes[a]
                    } else {
    ...
    if (!("Element" in self && "HTMLElement" in self)) {
        ! function () {
            function e() {
                return l-- || clearTimeout(t), !(!document.body || document.body.prototype || !/(complete|interactive)/.test(document.readyState)) && (m(document, !0), t && document.body.prototype && clearTimeout(t), !!document.body.prototype)
            }
            if (!("Element" in self && "HTMLElement" in self)) {
        ...
        (function () {
            function e(t, r) {
                ...
                function c(e) {
                    ...
                    else if ("json" == e) t = c("json-stringify") && c("date-serialization") && c("json-parse");
                ...
                var f = t.Number || o.Number,
                    ...
                    h = t.Math || o.Math,
                    y = t.JSON || o.JSON;
                "object" == typeof y && y && (r.stringify = y.stringify, r.parse = y.parse);
                var b, d = u.prototype,
                    j = d.toString,
                    C = d.hasOwnProperty,
                ...
                if (i(function () {
                    ...
                    var S = c("bug-string-char-index"),
                        O = function (e, t) {
                            ...
                            return r = o = null, c ? O = function (e, t) {
                                var n, r, o = "[object Function]" == j.call(e);
                                for (n in e) o && "prototype" == n || !C.call(e, n) || (r = "constructor" === n) || t(n);
                                (r || C.call(e, n = "constructor")) && t(n)
                            } : (o = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"], O = function (e, t) {
                                var r, i, c = "[object Function]" == j.call(e),
                                    a = !c && "function" != typeof e.constructor && n[typeof e.hasOwnProperty] && e.hasOwnProperty || C;
                        ...
                        if (c("json-stringify") && !c("date-serialization")) {
                            ...
                            var x = function (e) {
                                ...
                                m = function (e, t, n, r, o, c, a) {
                                    ...
                                    if (i(function () {
                                            f = t[e]
                                        }), "object" == typeof f && f && (f.getUTCFullYear && "[object Date]" == j.call(f) && f.toJSON === s.prototype.toJSON ? f = A(f) : "function" == typeof f.toJSON && (f = f.toJSON(e))), n && (f = n.call(t, e, f)), f == b) return f === b ? f : "null";
                                    switch (l = typeof f, "object" == l && (u = j.call(f)), u || l) {
                                        case "boolean":
                                        case "[object Boolean]":
                                            return "" + f;
                                        case "number":
                                    ...
                                    if ("object" == typeof f) {
                                        ...
                                        if (a.push(f), p = [], C = c, c += o, "[object Array]" == u) {
                                            for (y = 0, d = f.length; y < d; y++) h = m(y, f, n, r, o, c, a), p.push(h === b ? "null" : h);
                                            v = p.length ? o ? "[\n" + c + p.join(",\n" + c) + "\n" + C + "]" : "[" + p.join(",") + "]" : "[]"
                                        } else O(r || f, function (e) {
                    ...
                    if (!c("json-parse")) {
                        var M, F, z = l.fromCharCode,
                            ...
                            Z = function (e) {
                                ...
                                if ("$" == e && E(), "string" == typeof e) {
                                    ...
                                    if ("[" == e) {
                                        for (t = [];
                                            "]" != (e = P());) n ? "," == e ? "]" == (e = P()) && E() : E() : n = !0, "," == e && E(), t.push(Z(e));
                                        return t
                                    }
                                    if ("{" == e) {
                                        for (t = {};
                                            "}" != (e = P());) n ? "," == e ? "}" == (e = P()) && E() : E() : n = !0, "," != e && "string" == typeof e && "@" == (S ? e.charAt(0) : e[0]) && ":" == P() || E(), t[e.slice(1)] = Z(P());
                                        return t
                                    }
                                    E()
                                }
                        ...
                        r.parse = function (e, t) {
                            var n, r;
                            return M = 0, F = "" + e, n = Z(P()), "$" != P() && E(), M = F = null, t && "[object Function]" == j.call(t) ? I((r = {}, r[""] = n, r), "", t) : n
                        }
                    }
                }
    ...
    if (!("keys" in Object && function () {
        ...
        CreateMethodProperty(Object, "keys", function () {
            ...
            function r(t) {
                ...
                return e || (e = "[object Array]" !== r && null !== t && "object" == typeof t && "number" == typeof t.length && t.length >= 0 && "[object Function]" === n.call(t.callee)), e
            }
            var e = Object.prototype.hasOwnProperty,
                ...
                f = function () {
                    ...
                    for (var t in window) try {
                        if (!a["$" + t] && e.call(window, t) && null !== window[t] && "object" == typeof window[t]) try {
                            u(window[t])
                        } catch (r) {
                            return !0
                        }
            ...
            return function s(o) {
                ...
                if (a && o.length > 0)
                    ...
                    for (var w in o) t() && "__proto__" === w || y && "prototype" === w || !e.call(o, w) || s.push(String(w));
                if (c)
                    for (var d = p(o), $ = 0; $ < i.length; ++$) d && "constructor" === i[$] || !e.call(o, i[$]) || s.push(i[$]);
                return s
            }
        }());
    }
    ...
    if (!("setPrototypeOf" in Object)) {
        ! function () {
            if (!Object.setPrototypeOf) {
                var t, e, o = Object.getOwnPropertyNames,
    ...
    if (!("trimEnd" in String.prototype && function () {
            var n = "​᠎"
            return !"\t\n\x0B\f\r                　\u2028\u2029\ufeff".trimEnd() && n.trimEnd() === n
        }())) {
        CreateMethodProperty(String.prototype, "trimEnd", function t() {
            "use strict";
            var t = this;
            return TrimString(t, "end")
        });
    }
    if (!("trimStart" in String.prototype && function () {
            var t = "​᠎"
            return !"\t\n\x0B\f\r                　\u2028\u2029\ufeff".trimStart() && t.trimStart() === t
        }())) {
        CreateMethodProperty(String.prototype, "trimStart", function t() {
            "use strict";
            var t = this;
            return TrimString(t, "start")
        });
    }
    if (!("Symbol" in self && 0 === self.Symbol.length)) {
        ! function (e, r, n) {
            ...
            if (I.value = U ? function () {
                    ...
                    var e = w.call(this);
                    return "[object String]" === e && W(this) ? "[object Symbol]" : e
                }, k(m, "toString", I), u = function (e, r, n) {
                    var t = E(m, r);
    ...
    if (!("getOwnPropertyDescriptor" in Object && "function" == typeof Object.getOwnPropertyDescriptor && function () {
            try {
                var t = {}
                return t.test = 0, 0 === Object.getOwnPropertyDescriptors(t).test.value
            } catch (e) {
                return !1
            }
        }())) {
        ...
        return function e(a, o, n) {
            ...
            for (var l = GetIterator(o);;) {
                ...
                try {
                    ...
                    return IteratorClose(l, I)
                }
                var u;
                try {
                    u = Get(i, "1")
                } catch (u) {
                    return IteratorClose(l, u)
                }
                try {
                    Call(n, a, [I, u])
                } catch (v) {
                    return IteratorClose(l, v)
                }
            }
        }
    }();
    ...
    if (!("from" in Array && function () {
            try {
                return Array.from({
                    length: -Infinity
                }), "a" === Array.from(new self.Set(["a"]))[0] && "a" === Array.from(new self.Map([
                    ["a", "one"]
                ]))[0][0]
            } catch (r) {
                return !1
    ...
    if (!((function (r) {
        ...
        ! function (e) {
            ...
            function t(t) {
                ...
                function i(e) {
                    var a = this;
                    this._list = [], e === undefined || null === e || (e instanceof i ? this._list = r(String(e)) : "object" == typeof e && t(e) ? Array.from(e).forEach(function (e) {
                    ...
                    }) : (e = String(e), "?" === e.substring(0, 1) && (e = e.substring(1)), this._list = r(e))), this._url_object = null, this._setList = function (e) {
                        o || (a._list = e)
                    };
                    var o = !1;
                    this._update_steps = function () {
                        o || (o = !0, a._url_object && ("about:" === a._url_object.protocol && -1 !== a._url_object.pathname.indexOf("?") && (a._url_object.pathname = a._url_object.pathname.split("?")[0]), a._url_object.search = n(a._list), o = !1))
                    }
                }
                ...
                try {
                    if (c) {
                        if ("searchParams" in (l = new e.URL("http://example.com"))) {
                            ...
                            if (s.search = "a=1&b=2", "http://example.com/?a=1&b=2" === s.href && (s.search = "", "http://example.com/" === s.href)) return
                        }
                        "href" in l || (l = undefined), l = undefined
                    }
                } catch (h) {}
                if (Object.defineProperties(i.prototype, {
                    ...
                    for (var f in c) Object.prototype.hasOwnProperty.call(c, f) && "function" == typeof c[f] && (u[f] = c[f]);
                e.URL = u, e.URLSearchParams = i
            }(),
            function () {
                if ("1" !== new e.URLSearchParams([
                    ...
                    e.URLSearchParams = function (e) {
                        ...
                        return e && "object" == typeof e ? (r = new n, Object.keys(e).forEach(function (t) {
                            r.set(t, e[t])
                        }), r) : new n(e)
                    }
                }
